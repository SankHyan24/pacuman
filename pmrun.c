...
bool runifkey(int key, int event) // �ж��Ƿ��Ƕ�Ӧ�����ļ���
{
...
void Lost_Win() // �ж�ʤ������ʧ�ܣ���������Ӧ����
{
    int i;
    if (GmSts.score == GmSts.scoregoal) // ʤ��
    {
        RANKAD
        free(GmSts.map);
        winorlost = 1;
    ...
    else if (GmSts.skin == Skin_hulk2)
    {
        ...
        {
            if (GmSts.ifghst[i])
                if (Juli(GmSts.ghst[i], GmSts.player) == 1) // ��ײ�����������
                {
                    bool flag = 1;
        ...
        {
            if (GmSts.ifghst[i])
                if (Juli(GmSts.ghst[i], GmSts.player) == 2) // ��ײ�����������
                {
                    bool flag = 0;
                    if (GmSts.ghstd[i] == Dir_down && GmSts.plyrd == Dir_up)
                        flag = 1;
